...
export const tr: Messages = {
  ...
  "backup.eyebrow": "Yedek · Taşınabilir ve yerel",
  "backup.title": "Tam yedekleme ve kurtarma",
  "backup.description": "Ayarları, çalışma alanlarını, kaynak listelerini, monitör geçmişini, okuma durumunu, yerel iş akışı verilerini ve defteri tek sürümlü dosyada dışa aktarın.",
  "backup.last": "Son tam yedek: {date}",
  "backup.never": "Henüz tam yedek indirilmedi. Haftalık yedek önerilir.",
  "backup.download": "Tam yedeği indir",
  "backup.downloaded": "Tam yedek indirildi ve yerel kurtarma anlık görüntüsü kaydedildi.",
  "backup.boundary": "Yeniden oluşturulabilen yayın önbelleği ve Chrome izinleri dahil edilmez. Geri yüklenen çevrimiçi kaynaklar için yeniden izin gerekir.",
  "backup.chooseFile": "Yedek dosyası seç",
  "backup.previewFirst": "Herhangi bir veri değişmeden önce dosya doğrulanır ve önizlenir.",
  "backup.preview": "İçe aktarma önizlemesi",
  "backup.previewReady": "Doğrulanmış yedek",
  "backup.settingsCount": "Ayar ve yerel değerler",
  "backup.notesCount": "Notlar",
  "backup.referencesCount": "Referanslar",
  "backup.conflictsCount": "Çakışmalar",
  "backup.showConflicts": "Çakışma raporunu göster",
  "backup.merge": "Üzerine yazmadan birleştir",
  "backup.replace": "Yerel verilerin yerine koy",
  "backup.replaceConfirm": "Mevcut BenchTab verileri bu doğrulanmış yedekle değiştirilsin mi? Önce yerel bir geri dönüş anlık görüntüsü oluşturulacak.",
  "backup.restored": "Yedek geri yüklendi. BenchTab içe aktarılan verilerle yeniden açılacak.",
  "backup.invalid": "Yedek geçersiz.",
  "backup.failed": "Yedek işlemi başarısız oldu.",
  "backup.snapshots": "Yerel kurtarma anlık görüntüleri · son 3",
  "backup.noSnapshots": "Henüz yerel kurtarma anlık görüntüsü yok.",
  "backup.reason.download": "İndirilen yedek",
  "backup.reason.pre-restore": "Geri yükleme öncesi",
  "backup.downloadSnapshot": "İndir",
  "backup.previewSnapshot": "Geri yüklemeyi önizle",
  ...
  "overview.status.fullBackupDone": "Tam BenchTab yedeği indirildi.",
  "overview.status.backupFailed": "Tam yedek oluşturulamadı.",
