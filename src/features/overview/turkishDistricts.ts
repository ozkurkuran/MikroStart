// Turkish second-level administrative names derived from GeoNames admin2Codes.txt
// (2026-08-28), licensed under CC BY 4.0: https://www.geonames.org/
...
export const TURKISH_DISTRICTS = Object.entries(DISTRICTS_BY_PROVINCE).flatMap(([province, districts]) =>
  districts.split("|").map((district) => ({ district, province })),
);
